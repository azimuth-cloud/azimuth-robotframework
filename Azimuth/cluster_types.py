...
class ClusterTypeKeywords:
    ...
    @keyword
    def list_cluster_types(self) -> list[dict[str, t.Any]]:
        """
    ...
    @keyword
    def fetch_cluster_type(self, name: str) -> dict[str, t.Any]:
        """
    ...
    @keyword
    def find_cluster_type_by_name(self, name: str) -> dict[str, t.Any]:
        """
        Fetches a cluster type by name using the active client.
        """
    ...
    def get_defaults_for_cluster_type(
        self, cluster_type: dict[str, t.Any]
    ) -> dict[str, t.Any]:
        """
