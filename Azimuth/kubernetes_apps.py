...
class KubernetesAppKeywords:
    ...
    @keyword
    def list_kubernetes_apps(self) -> list[dict[str, t.Any]]:
        """
    ...
    @keyword
    def fetch_kubernetes_app_by_id(self, id: str) -> dict[str, t.Any]:  # noqa: A002
        """
    ...
    @keyword
    def find_kubernetes_app_by_name(self, name: str) -> dict[str, t.Any]:
        """
    ...
    @keyword
    def delete_kubernetes_app(self, id: str, interval: int = 15):  # noqa: A002
        """
    ...
    @keyword
    def wait_for_kubernetes_app_deployed(
        self,
        id: str,  # noqa: A002
        interval: int = 15,
    ) -> dict[str, t.Any]:
    ...
    @keyword
    def wait_for_kubernetes_app_service_url(
        self,
        id: str,  # noqa: A002
        name: str,
        interval: int = 15,
        ...
        """
        # We also consider the given name with the app id prefixed, as that is how the
        # names are constructed in the Helm releases of the reference charts
